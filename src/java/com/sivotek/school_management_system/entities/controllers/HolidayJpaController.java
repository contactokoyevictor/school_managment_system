...
import com.sivotek.school_management_system.entities.Holiday;
 ...
 * @author MY USER
 */
public class HolidayJpaController implements Serializable {

    public HolidayJpaController(UserTransaction utx, EntityManagerFactory emf) {
        this.utx = utx;
        this.emf = emf;
    }
    ...
    public void create(Holiday holiday) throws PreexistingEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            if (findHoliday(holiday.getHolidayId()) != null) {
    ...
    public void edit(Holiday holiday) throws NonexistentEntityException, RollbackFailureException, Exception {
        EntityManager em = null;
        try {
            utx.begin();
            em = getEntityManager();
