...
<!--CREATION FORM STARTS-->
                    <form method="POST" commandName="SubjectPOJO" action="${cpk}/${login_type}/modal_edit_subject/" id="form" class="form-horizontal form-groups-bordered validate" enctype="multipart/form-data">
                      <input type="hidden" name="subject_id" value="${SubjectPOJO.getSubjectId()}"/>
                      ...
                      <div class="col-sm-6 controls">
                          <select name="academic_year" class="form-control" data-validate="required" data-message-required="value required">
                                ...
                                <c:forEach items="${academicYearList}" var="academicYr">
                                  <option value="${academicYr.year_id}"  <c:if test="${academicYr.year_id == SubjectPOJO.getAcademicYear().getYearId()}">selected="true"</c:if>>
                                ...
                                <div class="col-sm-6 controls">
                                    <select name="class_category_id"  class="form-control" id="class_category_id" data-validate="required" data-message-required="value required">
                                          ...
                                          <c:forEach items="${classCategoryPOJOList}" var="category">
                                            <option value="${category.category_id}"  <c:if test="${category.category_id == SubjectPOJO.getClassCategoryId().getCategoryId()}">selected="true"</c:if>>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-6 controls">
                            <input type="text" class="form-control" name="name" data-validate="required" data-message-required="value required" value="${SubjectPOJO.getName()}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 controls">
                            <input type="text" class="form-control" name="code" data-validate="required" data-message-required="value required" value="${SubjectPOJO.getCode()}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 controls">
                            <input type="text" class="form-control" name="nick_name" data-validate="required" data-message-required="value required" value="${SubjectPOJO.getNickName()}">
                        </div>
                    </div>
